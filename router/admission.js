...
router.post("/admission-process", upload.any(), function(req, res) {
  var query =
    "INSERT INTO Admission (ChildName, DateOfBirth, Age, NumberOfSiblings, Gender, GuardianFullName, Occupation, Nationality, " +
  ...
  var data = [
    ...
    req.files[1].path,
    req.body.grandName,
    req.body.grandProfession,
    req.body.grandAdrress
  ];
